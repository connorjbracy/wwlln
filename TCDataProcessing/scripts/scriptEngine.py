...
def run_matlab_script(function_name,parameters='nargout=0'):
    wwlln_logger.info("Attempting to run MATLAB scrypt: {scrypt_str}".format(scrypt_str=function_name))
...
def run_python_script(script_name, function_name,parameters=''):
    wwlln_logger.info("Attempting to run PYTHON scrypt: {scrypt_str}".format(scrypt_str=function_name))
